...
SHOWCASE_RULES: list[tuple[str, Any, str, str, float]] = [
    # (dot_path, expected_value, scene_type, label, duration_seconds)
    ("showcase.kind", "hero-intro", "title", "Hero Intro", 6.0),
    ("showcase.kind", "screenflow", "comparison", "Screenflow Demo", 8.0),
    ("showcase.kind", "svg-morph", "svg-morph", "SVG Morph", 5.0),
    ("showcase.kind", "kinetic-text", "kinetic-text", "Kinetic Typography", 5.0),
    ("showcase.kind", "canvas-composite", "canvas-composite", "Canvas Composite", 5.0),
    ("showcase.kind", "real-estate", "real-estate", "Real Estate Showcase", 7.0),
    ("showcase.kind", "promo", "promo", "Promo", 6.0),
    ("showcase.kind", "three-scene", "three-scene", "3D Scene", 7.0),
    ("showcase.kind", "trajectory-timeline", "timeline", "Trajectory Timeline", 7.0),
    ("showcase.kind", "3d-ranking", "chart", "3D Ranking", 6.0),
    ("showcase.kind", "audio-reactive", "title", "Audio Reactive", 6.0),
    ("showcase.kind", "dual-chart", "chart", "Dual Chart", 7.0),
    ("showcase.kind", "document-highlight", "title", "Document Highlight", 5.0),
    ("showcase.kind", "overlay-cta", "outro", "Overlay CTA", 4.0),
]
...
def _detect_showcase_pattern(content: dict[str, Any]) -> dict[str, Any] | None:
    ...
    Returns scene dict with scene_type, title, text, duration if match found.
    """
